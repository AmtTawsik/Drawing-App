...
const FaqsCard = (props) => {
  ...
  return (
    ...
    >
      ...
      >
        <div>
          <p className="text-fuchsia-500">{faqsList.a}</p>
        </div>
      </div>
    </div>
  );
...
const FaQ = () => {
  const faqsList = [
    ...
    {
      q: "Is Drawing importent in our life?",
  ...
  return (
    <section className="leading-relaxed max-w-screen-xl mt-5 mx-auto px-4 lg:px-8">
      <div className="space-y-3 text-center">
        <h1 className="font-bold text-2xl md:text-5xl text-white pt-10">
