            ...
            <div>
              ...
              <div className="flex flex-col items-start">
                <input
                  type="text"
                  name="name"
                  className="block w-full mt-1 p-2 border-gray-300 rounded-md shadow-lg text-white focus:ring-indigo-200 focus:ring-opacity-50"
                  required
                />
              </div>
            </div>
            ...
            <div className="mt-4">
              ...
              <div className="flex flex-col items-start">
                <input
                  type="text"
                  name="photo"
                  className="block w-full mt-1 p-2 border-gray-300 rounded-md shadow-lg text-white focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                  required
                />
              </div>
            </div>
